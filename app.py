...
share_of_voice_agent = Agent(
    ...
    "STEP 2: AGGREGATE SHARE-OF-VOICE",
    "- Across the corpus compute total_mentions and quoted_mentions per bucket and convert to percentages summing to 100%.",
    "- For each stakeholder include: percentage include canonical_name, prcentage, example_quote, and article_id (URL).",
    
    "STEP 3: COMPUTE TOP ENTITIES",
